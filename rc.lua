...
local graphic_text_editor  = "codium"
local music_player         = "spotify"
local session_lock_command = "i3lock -c 0f0e17"
...
local current_keyboard_layout = "gb";
local toggle_keyboard_layout = function()
  local command = "setxkbmap -display :0 -layout ";
  if current_keyboard_layout == "gb" then
    command = command .. "gb";
    current_keyboard_layout = "gb";
  else
    command = command .. "gb";
    current_keyboard_layout = "gb";
  end
...
local global_keys = awful.util.table.join(
  ...
  awful.key({ "Mod4" }, "b", function() awful.spawn(browser) end, { description="Execute default web browser(" .. browser .. ")", group="Application" }),
  awful.key({ "Mod4", "Control", "Shift" }, "Cyrillic_i", function() awful.spawn(browser) end),

  awful.key({ "Mod4" }, "c", function() awful.spawn(graphic_text_editor) end, { description="Execute default graphic text editor(" .. graphic_text_editor .. ")", group="Application" }),
  awful.key({ "Mod4", "Control", "Shift" }, "Cyrillic_u", function() awful.spawn(graphic_text_editor) end),

  awful.key({ "Mod4" }, "m", function() awful.spawn(music_player) end, { description="Execute default music player(" .. music_player .. ")", group="Application" }),
  awful.key({ "Mod4", "Control", "Shift" }, "Cyrillic_softsign", function() awful.spawn(music_player) end),

  awful.key({ "Mod4" }, "e", function() awful.spawn(file_manager) end, { description="Execute default file manager(" .. file_manager .. ")", group="Application" }),
  awful.key({ "Mod4", "Control", "Shift" }, "Cyrillic_a", function() awful.spawn(file_manager) end),

  awful.key({ "Mod4", "Control", "Shift" }, "s", function() awful.spawn("flameshot full -p ~/Pictures/screenshot/") end, { description="Execute Deepin Screenshot", group="Application" }),
...
local client_keys = awful.util.table.join(
  ...
  awful.key({ "Mod4" }, "q", function (c) c:kill() end, { description="Kill focused client", group="Client" }),
  ...
  awful.key({ "Mod4" }, "r", function() awful.spawn("rofi -show run") end, { description="Execute default music player(" .. music_player .. ")", group="Application" })
)
